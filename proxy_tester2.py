...
# 
pub_urls = ['http://example.com/', 'http://sns.cs.princeton.edu/', 'http://www.cs.princeton.edu/people/faculty','http://www.cs.princeton.edu/sites/default/files/styles/gallery_full/public/gallery-images/CS_building9.jpg?itok=meb0LzhS'];
...
def get_direct(host, port, url):
     ...
     print getstring % (url, host)
     data = http_exchange("172.31.1.4", 8080,  getstring % (url, host))
  #   print data
     return data.split('\n')
